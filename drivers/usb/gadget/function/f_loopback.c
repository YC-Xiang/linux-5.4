...
DECLARE_USB_FUNCTION(Loopback, loopback_alloc_instance, loopback_alloc); // 定义了一个usb_function_driver
...
{
	return usb_function_register(&Loopbackusb_func); /// 将Loopbackusb_func->list加入func_list
}
