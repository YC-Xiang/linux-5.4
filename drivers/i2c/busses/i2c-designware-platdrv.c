...
static struct pinctrl *i2c_pinctrl;
...
static int dw_i2c_plat_probe(struct platform_device *pdev)
{
	...
	i2c_pinctrl = devm_pinctrl_get(&pdev->dev);
	if (IS_ERR(i2c_pinctrl))
		return PTR_ERR(i2c_pinctrl);

	default_state = pinctrl_lookup_state(i2c_pinctrl,
	...
	ret = pinctrl_select_state(i2c_pinctrl, default_state);
	if (ret) {
